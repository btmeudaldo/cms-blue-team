    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-white flex flex-col justify-between selection:bg-[#1a80ff] selection:text-white transition-colors duration-200">
      ...
      <main className="flex-1 mx-auto w-full max-w-7xl px-6 py-16 lg:py-24 flex flex-col items-center text-center justify-center space-y-12">
        <div className="space-y-6 max-w-3xl">
          <div className="inline-flex items-center gap-2 rounded-full border border-blue-500/30 bg-blue-50 dark:bg-blue-500/10 px-4 py-1.5 text-xs font-bold text-[#1a80ff]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full text-left pt-8">
          <div className="rounded-3xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900/60 p-8 space-y-3 shadow-sm hover:border-blue-400 dark:hover:border-blue-500/40 transition-all">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-50 dark:bg-blue-500/10 text-[#1a80ff] text-2xl font-bold">
              ⏱️
            </div>
      ...
      {/* Footer */}
      <footer className="border-t border-slate-200 bg-slate-100 dark:border-slate-800 dark:bg-slate-950 py-8 text-center text-xs text-slate-500 dark:text-slate-500 transition-colors">
