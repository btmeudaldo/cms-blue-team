...
insert into public.profiles (id, role) values ('00000000-0000-0000-0000-000000000101', 'student');
...
set local role authenticated;
select throws_ok('select public.complete_lesson(''00000000-0000-0000-0000-000000000301''::uuid)', 'Minimum reading time has not elapsed', 'completion before the minimum is rejected');

reset role;
update public.user_lesson_progress set started_at = clock_timestamp() - interval '2 seconds';
set local role authenticated;
